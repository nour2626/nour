...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST["siteName"]) && !empty(trim($_POST["siteName"])) && isset($_POST["confirmation"]) && $_POST["confirmation"] === "DELETE") {
        // Retrieve the site name from the form
        $siteName = trim($_POST["siteName"]);

        // Call the deleteSite method
        if ($sitesController->deleteSite($siteName)) {
            // Redirect after successful deletion
            header("Location: sitesList.php"); // Redirect to your site list page
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                ...
                <li class="nav-item"> <a class="nav-link" href="../../pages/ui-features/createsite.php">add</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../../pages/ui-features/deletesite.php">delete</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../../pages/ui-features/updatesite.php">update</a></li>
...
<head>
    ...
    <script>
        ...
        function validateForm() {
            ...
            // Check if site name and confirmation are provided
            if (siteName === "" || confirmation === "") {
...
.container {
    ...
    margin: 50px auto; /* Centers the form container horizontally */
}
...
<body>
    <div class="container">
        ...
        <!-- Delete Site Form -->
        <form method="POST" action="deleteSite.php" onsubmit="return validateForm()">
