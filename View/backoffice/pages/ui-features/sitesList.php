...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    try {
        if ($sitesController->deleteSite($deleteId)) {
            header("Location: sitesList.php?success=Site deleted successfully!");
            exit();
        } else {
            header("Location: sitesList.php?error=Failed to delete site. Please try again.");
            exit();
        }
    } catch (Exception $e) {
        header("Location: sitesList.php?error=" . urlencode($e->getMessage()));
        exit();
    }
}
?>
...
<body>
    <div class="container mt-5">
        <h1 class="text-center">Sites List</h1>
        <div class="text-center mb-4">
            <a href="createsite.php" class="btn btn-primary">Create New Site</a>
        </div>
            ...
            <?php if (!empty($sitesList)) { ?>
                <?php foreach ($sitesList as $site) { ?>
                    <div class="col-md-4">
                        <div class="card mb-4">
                            <!-- Display site image -->
                            <img src="uploads/<?php echo htmlspecialchars($site['images']); ?>" class="card-img-top" alt="Site Image" style="height: 200px; object-fit: cover;">
                            <div class="card-body">
                                ...
                                <!-- Update Button -->
                                <a href="updatesite.php?id=<?php echo htmlspecialchars($site['id']); ?>" class="btn btn-warning btn-sm">Update</a>

                                <!-- Delete Button -->
                                <form method="POST" action="" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this site?');">
                                    <input type="hidden" name="delete_id" value="<?php echo htmlspecialchars($site['id']); ?>">
                                    <button type="submit" class="btn btn-danger btn-sm">Delete</button>
                                </form>
                                
                                <a href="viewcomments.php?site_id=<?php echo htmlspecialchars($site['id']); ?>" class="btn btn-info btn-sm">View Comments</a>
